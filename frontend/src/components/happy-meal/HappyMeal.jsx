  ...
  useEffect(() => {
    const calculateTimeLeft = () => {
      ...
      happyMealOffers.forEach(offer => {
        const difference = offer.endDate - now;
        ...
        if (difference > 0) {
          ...
          newTimeLeft[offer.id] = { days: 0, hours: 0, minutes: 0 };
        }
      });
            ...
            >
              ...
              <div className="offer-content">
                ...
                <div className="offer-timer">
                  <FaClock />
                  <span>
                    {timeLeft[offer.id]?.days} days, {timeLeft[offer.id]?.hours} hrs left
                  </span>
                </div>
                
                {offer.toys && offer.toys.length > 0 && (
